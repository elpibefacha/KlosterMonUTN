...
void ArchivoKlostermon::cargarConsola()
{
	...
	cout << "Mod de vida total propia" << endl;
	int vidaTotal;
	cin >> vidaTotal;
	creado.ataquePesado.setModVidaTotal(vidaTotal);
	cout << "Mod de vida total enemiga" << endl;
	int vidaTotalEnemiga = 0;
	cin >> vidaTotalEnemiga;
	creado.ataquePesado.setModVidaTotalEnemiga(vidaTotalEnemiga);
	...
	vidaTotal = 0;
	cin >> vidaTotal;
	creado.ataqueEspecial.setModVidaTotal(vidaTotal);
	vidaTotalEnemiga = 0;
	cin >> vidaTotalEnemiga;
	cout << "Mod de vida total enemiga" << endl;
	cin >> vidaTotalEnemiga;
	creado.ataqueEspecial.setModVidaTotalEnemiga(vidaTotalEnemiga);
	cout << "Efectividad ataque" << endl;
	cin >> efecti;
